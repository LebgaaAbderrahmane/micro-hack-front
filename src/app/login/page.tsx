...
export default function LoginPage() {
    ...
    const handleRoleSelect = (role: Role) => {
        const mockUser = {
            ...
            role: role,
            firstName: role.split('_').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' '),
            lastName: "User",
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-foreground/50 text-sm">Intelligent Logistics Access Control</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-foreground/60 max-w-md">
                            The next generation of maritime port access management. Select your role to enter the portal.
                        </p>
                    </div>
                ...
                <div className="glass-card p-8 space-y-6 hidden md:block">
                    <div className="flex items-center gap-4 border-b border-white/10 pb-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-foreground/40">Enter your credentials to continue</p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <a href="#" className="text-xs text-primary/60 hover:text-primary underline transition-colors">Forgot your password?</a>
                    </div>
                </div>
            </div>
        </div>
