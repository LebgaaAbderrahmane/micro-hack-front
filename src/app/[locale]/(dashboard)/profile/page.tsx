...
export default function ProfilePage() {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20 text-foreground">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-foreground/5">
                ...
                <div className="flex gap-3">
                    ...
                    <button 
                        ...
                        className="px-6 py-3 bg-primary text-primary-foreground rounded-xl text-xs font-black uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-primary/20"
                    >
                        Edit Profile
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-8">
                    <div className="glass-card border border-foreground/10 overflow-hidden bg-foreground/5 rounded-3xl relative">
                        <div className="h-32 bg-gradient-to-br from-primary/20 via-background to-transparent border-b border-foreground/5"></div>
                        <div className="px-8 pb-10">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-foreground">{profile.username}</h2>
                            ...
                            <div className="mt-8 space-y-4">
                                <div className="flex flex-col gap-1 p-4 bg-foreground/5 rounded-2xl border border-foreground/5">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="glass-card p-8 border border-foreground/5 rounded-3xl bg-foreground/5">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-6 rounded-2xl bg-foreground/[0.03] border border-foreground/5 hover:bg-foreground/[0.05] transition-all">
                            ...
                            <div className="flex items-center justify-between p-6 rounded-2xl bg-foreground/[0.03] border border-foreground/5 hover:bg-foreground/[0.05] transition-all opacity-50 grayscale">
                                <div className="flex items-center gap-5">
                    ...
                    <div className="glass-card p-8 border border-foreground/5 rounded-3xl bg-foreground/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-6 rounded-2xl bg-foreground/[0.03] border border-foreground/5">
                                <p className="text-[10px] font-black text-foreground/30 uppercase tracking-widest mb-1">Current Role</p>
                                <p className="text-lg font-black text-foreground">{profile.role}</p>
                            ...
                            <div className="p-6 rounded-2xl bg-foreground/[0.03] border border-foreground/5">
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    ...
                                    <span className="text-[9px] font-black px-2 py-1 bg-foreground/5 text-foreground/20 rounded-md border border-foreground/5 cursor-not-allowed">WRITE</span>
                                </div>
                            </div>
                        </div>
                    </div>
