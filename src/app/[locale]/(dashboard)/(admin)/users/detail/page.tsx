    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-4">
        ...
        <p className="text-foreground/50">
          Only administrators can access this secure identity node.
        </p>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-foreground/50 font-medium font-mono text-xs uppercase tracking-widest flex items-center gap-2">
              <Database size={12} className="text-primary" /> NODE_SYS_ID:{" "}
              {user.id}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8 lg:col-span-1">
          ...
          <div className="glass-card p-6 border border-foreground/5 rounded-3xl bg-foreground/5">
            ...
            <div className="p-4 rounded-2xl bg-foreground/5 border border-foreground/5 flex items-center gap-4">
              ...
              <div>
                <p className="text-[10px] font-black text-foreground/20 uppercase tracking-widest leading-none mb-1">
                  Affiliation
                </p>
                <p className="font-bold text-sm truncate">
                  {user.organisation?.name || "Independent Authority"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-foreground/[0.03] border border-foreground/5 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] px-2 py-0.5 bg-primary/20 text-primary border border-primary/20 rounded-full font-black uppercase">
                    2 Active
                  </span>
                </div>
                <div className="space-y-1">
          ...
          <div className="glass-card p-8 border border-foreground/5 rounded-3xl bg-foreground/5">
            ...
            <div className="space-y-4">
              {[
                {
                  date: "Feb 04, 2026",
                  subject: "Port Authority System Update",
                  status: "Delivered",
                },
                {
                  date: "Jan 12, 2026",
                ...
                <div
                  key={i}
                  className="flex justify-between items-center p-4 bg-foreground/5 rounded-xl border border-foreground/5"
                >
                  <div>
                    <p className="text-xs font-bold">{log.subject}</p>
                    <p className="text-[10px] text-foreground/40">{log.date}</p>
                  </div>
                  <span className="text-[10px] font-black text-foreground/30 uppercase border border-foreground/10 px-2 py-0.5 rounded-md">
                    {log.status}
                  </span>
                </div>
              ))}
