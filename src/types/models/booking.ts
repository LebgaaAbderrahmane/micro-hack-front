...
export type BookingPriority = Database['public']['Enums']['booking_priority_enum'];
export type ContainerStatus = Database['public']['Enums']['container_status_enum'];
export type GateActionType = Database['public']['Enums']['gate_action_type_enum'];
export type OperationStatus = Database['public']['Enums']['operation_status_enum'];
export type SlotStatus = Database['public']['Enums']['slot_status_enum'];
export type SlotOverrideType = Database['public']['Enums']['slot_override_type_enum'];
