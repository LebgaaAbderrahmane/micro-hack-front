...
const UserRow = ({ user }: { user: User }) => {
    ...
    const roleIcons = {
        ...
        terminal_op: <UserCircle size={14} className="text-accent" />,
        carrier: <Truck size={14} className="text-primary" />
    };

    const roleColors = {
        admin: "text-error bg-error/10 border-error/5",
        terminal_op: "text-accent bg-accent/10 border-accent/5",
        carrier: "text-primary bg-primary/10 border-primary/5"
    };
